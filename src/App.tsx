...
const translations = {
  th: {
    ...
    hours: "เวลาทำการ",
    hoursData: [
      { day: "จันทร์", open: "09:00", close: "18:00" },
      { day: "อังคาร", open: "09:00", close: "18:00" },
      { day: "พุธ", open: "09:00", close: "18:00" },
      { day: "พฤหัสบดี", open: "09:00", close: "18:00" },
      { day: "ศุกร์", open: "09:00", close: "18:00" },
      { day: "เสาร์", open: null, close: null },
      { day: "อาทิตย์", open: "09:00", close: "18:00" },
    ],
    closed: "ปิด",
    categories: {
    ...
    items: {
      ...
      margaritaPizza: { name: "มาการิต้า", desc: "ซอสมะเขือ, มอสซาเรลล่าชีส, น้ำมันมะกอก, มะเขือเทศ, ใบโหระพา" },
      hawaiianPizza: { name: "ฮาวายเอี้ยน", desc: "ซอสมะเขือเทศ, มอสซาเรลล่าชีส, แฮม, สัปปะรด" },
      parmaHamPizza: { name: "พาร์มาแฮม", desc: "ซอสมะเขือเทศ, มอสซาเรลล่าชีส, พาร์มาแฮม" },
      napoliPizza: { name: "นาโปลี", desc: "ซอสมะเขือเทศ, มอสซาเรลล่าชีส, ปลาแองโชวี, มะกอกดำ" },
      tunaPizza: { name: "ทูน่า", desc: "ซอสมะเขือเทศ, มอสซาเรลล่าชีส, ทูน่า, หอมใหญ่" },
    },
    footer: "© 2024 Kitty Cafe · สงวนลิขสิทธิ์",
    mapLabel: "แผนที่",
  ...
  en: {
    ...
    items: {
      ...
      margaritaPizza: { name: "Margarita", desc: "Tomato sauce, mozzarella, olive oil, tomato, basil" },
      hawaiianPizza: { name: "Hawaiian", desc: "Tomato sauce, mozzarella, ham, pineapple" },
      parmaHamPizza: { name: "Parma Ham", desc: "Tomato sauce, mozzarella, parma ham" },
      napoliPizza: { name: "Napoli", desc: "Tomato sauce, mozzarella, anchovies, black olives" },
      tunaPizza: { name: "Tuna", desc: "Tomato sauce, mozzarella, tuna, onion" },
    },
    footer: "© 2024 Kitty Cafe · All Rights Reserved",
    mapLabel: "Location",
...
const menuData = [
  ...
  },
  {
    ...
    color: "#6B1A1A",
    items: [
      { key: "margaritaPizza",     price: "S 109 / M 149 / L 219", tag: null },
      { key: "hawaiianPizza",      price: "S 129 / M 169 / L 249", tag: null },
      { key: "parmaHamPizza",      price: "S 139 / M 179 / L 269", tag: null },
      { key: "napoliPizza",        price: "S 139 / M 179 / L 259", tag: null },
      { key: "tunaPizza",          price: "S 129 / M 169 / L 259", tag: null },
